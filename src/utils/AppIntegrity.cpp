...
AppIntegrity::AppIntegrity(Settings *  settings)
{
    ...
    if (QApplication::platformName() == "cocoa")
        currentDir = currentDir.remove(OSX_DIR_SUFFIX);
    ...
    if(settings->app()->get("Main", "Enable_Exit_Menu").toString() == "true")
    {
    ...
    if(settings->mainMenu()->get("sounds","game_sounds").toString() == "true")
    {
        ...
        if(settings->mainMenu()->get("sounds","wheel_click").toString() == "true")
        {
    ...
    if(settings->app()->get("IntroVideo","Use_intro").toString() == "true")
    {
    ...
    if(settings->app()->get("Resolution","Scanlines_Active").toString() == "true")
    {
